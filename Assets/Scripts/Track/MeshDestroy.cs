...
public class MeshDestroy : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            GameObject.transform.position = original.transform.position;// new Vector3( original.transform.position.x, original.transform.position.y+0.1f, original.transform.position.z);
            ...
            if (original.gameObject.tag == "Carteles")
            {
                rigidbody.mass = 5;
            }
            else
