...
public class Powerup : ScriptableObject
{
    ...
    //public Sprite itemIconStore;  // <--- Comentado sacamos el itemIcon trnasparente para el store tmb
    public Sprite backIconStore;
    public SpawnedPowerup prefab;
    public ClassPart _class;
    ...
    public void Use(NetworkRunner runner, KartEntity user)
    {
        if (prefab != null)
        {
            ...
            //prefab.idRandomPowerUp = user.idRandom;
