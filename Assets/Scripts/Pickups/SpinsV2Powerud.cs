...
public class SpinsV2Powerud : SpawnedPowerup
{
      ...
      if (kart != kartParent)
        {
            ...
            kart.Rigidbody.Rigidbody.AddRelativeForce(0, 500f + kartParent.Rigidbody.Rigidbody.velocity.magnitude * 25,0);
    ...
    {
        if (kart != null)kart.ImpactoKart(ClassPart.SPINSV2);
    }
}