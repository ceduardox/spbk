...
public static class ServerInfo {
    ...
    public static string TrackName => TranslateUI.getStringUI(ResourceManager.Instance.tracksDefinitions[TrackId].trackName);
    ...
    public static int MaxUsers {
        get => PlayerPrefs.GetInt("S_MaxUsers", 0);
